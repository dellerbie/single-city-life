namespace :db do
  ...
  task :populate_dummy_users do
    ...
    User.populate 100 do |user|
      user.login = Faker::Name.first_name.downcase + count.to_s
  ...
  task :populate_messages do 
    ...
    Message.populate 20 do |message|
      ...
      message.subject = Populator.words(1..5)
      message.message = Populator.sentences(1..4)
      message.read = true
      ...
      Message.populate 1 do |reply|
        ...
        reply.message = Populator.sentences(1..4)
        reply.read = true
